...
import CeleryLogs from "./CeleryLogs";
...
const SIDEBAR_ITEMS = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Modèles ML",  dot: "purple", page: "ml_models"   },
      { label: "Logs Celery", dot: "purple", page: "celery_logs"  },
    ]
  },
  {
    section: "SYSTÈME",
    items: [
      { label: "Logs d'audit", dot: "gray",  page: "audit_logs"   },
...
const PAGE_META = {
  ...
  ml_models:   { title: "Modèles ML",      breadcrumb: "Admin › IA / ML"      },
  celery_logs: { title: "Logs Celery",     breadcrumb: "Admin › IA / ML"      },
  audit_logs:  { title: "Logs d'audit",    breadcrumb: "Admin › Système"      },
};

// ─── USERS PAGE ───────────────────────────────────────────────────
function UsersPage({ onExpired }) {
...
export default function Dashboard({ onLogout }) {
  ...
  const renderPage = () => {
    switch (currentPage) {
      case 'users':       return <UsersPage    onExpired={handleExpired} />;
      case 'trades':      return <Trades       onExpired={handleExpired} />;
      case 'predictions': return <Predictions  onExpired={handleExpired} />;
      case 'prices':      return <MarketPrices onExpired={handleExpired} />;
      case 'portfolios':  return <Portfolios   onExpired={handleExpired} />;
      case 'ml_models':   return <MLModels     onExpired={handleExpired} />;
      case 'celery_logs': return <CeleryLogs   onExpired={handleExpired} />;
      case 'audit_logs':  return <AuditLogs    onExpired={handleExpired} />;
      default: return (
        <>
          ...
          <Charts onExpired={handleExpired} />
        </>
      );
    }
  };
