...
const styles = `
  ...
  * { margin: 0; padding: 0; box-sizing: border-box; }
  :root {
    ...
    --green: #00d48a; --orange: #f59e0b; --red: #f87171; --purple: #a78bfa; --blue: #60a5fa;
  }
  ...
  .mini-value { font-family: 'Space Mono', monospace; font-size: 26px; font-weight: 700; color: var(--text); }
  ...
  .filter-btn { padding: 6px 16px; border-radius: 20px; border: 1px solid var(--card-border); background: transparent; color: var(--text-dim); font-size: 11px; font-weight: 600; cursor: pointer; font-family: 'DM Sans', sans-serif; transition: all 0.15s; }
  .filter-btn:hover { border-color: var(--text-muted); color: var(--text); }
  .filter-btn.active-all    { background: rgba(255,255,255,0.06); color: var(--text); border-color: var(--text-muted); }
  .filter-btn.active-add    { background: rgba(0,212,138,0.12);  color: var(--green);  border-color: var(--green);  }
  .filter-btn.active-change { background: rgba(245,158,11,0.12); color: var(--orange); border-color: var(--orange); }
  .filter-btn.active-delete { background: rgba(248,113,113,0.12);color: var(--red);    border-color: var(--red);    }
  ...
  .model-chip { display: inline-block; padding: 2px 8px; border-radius: 6px; background: rgba(167,139,250,0.12); color: var(--purple); font-family: 'Space Mono', monospace; font-size: 10px; font-weight: 600; }
    ...
    <div className="admin-page">
      ...
      <div className="stats-row">
        <div className="mini-card">
          <div className="mini-label">Total actions</div>
          <div className="mini-value">{logs.length}</div>
          <div className="mini-sub">toutes périodes</div>
        </div>
        <div className="mini-card">
      ...
      <div className="table-card">
        <div className="table-header">
          <h3>Journal complet ({filtered.length})</h3>
        </div>
        <table>
          <thead>
            <tr>
